        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: "1.5rem" }}>
          {CATS.map((cat, i) => (
            <motion.div
              ...
              style={{ padding: "2.5rem", position: "relative", overflow: "hidden", cursor: "default", border: "1px solid var(--border)", background: "var(--bg)" }}
            >
              {/* Top color bar */}
              ...
              <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", marginBottom: "1.5rem" }}>
                <div>
                  ...
                  <h3 style={{ fontFamily: "var(--font-display)", fontSize: "1.3rem", fontWeight: 700, color: "var(--fg)", letterSpacing: "-0.02em" }}>
                    {cat.title}
                  </h3>
                </div>
                <div style={{ width: 40, height: 40, borderRadius: 0, background: "transparent", border: `1px solid var(--border-2)`, display: "flex", alignItems: "center", justifyContent: "center" }}>
                  <div style={{ width: 16, height: 16, borderRadius: "50%", background: "var(--red)" }} />
                </div>
              </div>
              ...
              >
                {cat.skills.map((skill) => (
                  <motion.span
                    ...
                    whileHover={{ scale: 1.1, borderColor: "var(--red)", color: "var(--red)" }}
                    className="tag"
